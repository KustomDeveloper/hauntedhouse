...
bush4.position.set(- 0.9, 0.1, 2.5)
...
const graveGeometry = new THREE.BoxBufferGeometry(0.4, 1.3, 0.1)
const graveMaterial = new THREE.MeshStandardMaterial({ color: '#b2b6b1' })

// Add a bunch of random gravestones
for(let i = 0; i < 50; i++) {
...
const tick = () =>
{
    ...
    const ghost3Angle = elapsedTime * 0.64
